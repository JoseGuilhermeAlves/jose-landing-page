...
/// (PROJECT.md §4.3). Os 5 nichos canonicos estao todos plugados:
...
export 'src/presentation/fitness/fitness_bloc.dart';
export 'src/presentation/fitness/fitness_demo.dart';
export 'src/presentation/fitness/fitness_event.dart';
export 'src/presentation/fitness/fitness_state.dart';
export 'src/presentation/realestate/realestate_bloc.dart';
export 'src/presentation/realestate/realestate_demo.dart';
export 'src/presentation/realestate/realestate_event.dart';
export 'src/presentation/realestate/realestate_state.dart';
