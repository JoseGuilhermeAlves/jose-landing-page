...
import 'package:feature_showcase/src/presentation/delivery/aurora_status_timeline.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          Product.formatBrl(line.subtotalCents),
          style: textTheme.bodyMedium?.copyWith(
            color: colors.onSurface,
            fontWeight: FontWeight.w600,
          ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          _Row(
            label: 'Subtotal',
            value: Product.formatBrl(itemsTotal),
            colors: colors,
            textTheme: textTheme,
          ),
          const SizedBox(height: AppSpacing.xs),
          _Row(
            label: 'Frete',
            value: fee == 0 ? 'Gratis' : Product.formatBrl(fee),
            colors: colors,
            textTheme: textTheme,
